    ...
    return (
        <Box component="footer" sx={{ bgcolor: 'grey.900', color: 'white', position: 'relative', overflow: 'hidden' }}>
            ...
            <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 2 }}>
                {/* Top section */}
                <Box sx={{ py: 8 }}>
                    <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(2, 1fr)', md: 'repeat(2, 1fr)', lg: 'repeat(4, 1fr)' }, gap: 4 }}>
                        {/* Company info */}
                        <Box>
                        ...
                        <Box>
                            <Stack spacing={3} alignItems="flex-start">
                                ...
                                <Stack spacing={1.5} alignItems="flex-start">
                                    {['About Us', 'FAQ', 'Testimonials', 'Services', 'Blog & News'].map((item, index) => (
                                        <MuiLink
                                            key={index}
